...
CREATE INDEX IF NOT EXISTS idx_price_history_security_time
ON price_history(security_id, observed_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_quotes_security_time
ON quotes(security_id, observed_at DESC);
